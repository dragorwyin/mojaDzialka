...
- **`best-effort`** — limited support; manual steps likely; expect friction (and bootstrapper's project's AI configuration file (AGENTS.md) generation compensates with extra ecosystem-specific context).
